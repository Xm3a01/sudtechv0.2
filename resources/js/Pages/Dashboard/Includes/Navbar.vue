<template>
    <header class="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-red-500">
            <div class="flex items-center">
                <button @click="sidebarControl" class="text-gray-500 focus:outline-none lg:hidden">
            ...
            <div class="flex items-center">
                <div  class="relative">
                    ...
                    <div v-show="notificationOpen"
                        class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl overflow-hidden z-10 border-t border-blue-500"
                ...
                <div class="relative">
                    ...
                    <div v-show="dropdownOpen"
                        class="absolute right-0 mt-2 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10 border-t border-blue-500"
                        style="display: none;">
                        <a href="#"
  ...
  export default {
      ...
      methods:{
          sidebarControl() {
              ...
              this.$emit('sidebarControl' , this.sidebarOpen);
          }
      }
  }
</script>